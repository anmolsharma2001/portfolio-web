      ...
      <div className="">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
          ...
          <div className="bg-purple-200 p-6 rounded-lg shadow-md hover:shadow-lg transition-all">
            <h3 className="text-xl font-semibold text-gray-900 mb-2">National Service Scheme Volunteer</h3>
          ...
          <div className="bg-yellow-100 p-6 rounded-lg shadow-md hover:shadow-lg transition-all">
            <h3 className="text-xl font-semibold text-gray-900 mb-2">Student Coordinator,<h5 className="text-sm">Student Council CSE, Medi-Caps University</h5></h3>
            {/* <p className="text-gray-600">
